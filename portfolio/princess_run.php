          ...
          <div class="row row-wrapper flex flex_box">
            ...
            <div class="col-md-6 col-wrapper">
              <div class="image-wrapper">
                <img class="portfolio-single-intro-img" alt="Game on Laptop" src="/img/princessrun/intro.png">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-sm-8 col-sm-offset-2">
              <p class="intro">The game was designed in illustrator and coded in javascript.</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-8">
              <img class="product" alt="Final Game" src="/img/princessrun/overview.png">
            </div>
            <div class="col-md-4">
          ...
          <div class="row process-row-wrapper">
            ...
            <div class="col-md-1 hidden-xs hidden-sm inner-navbar-wrapper">
              <nav class="inner-navbar">
                <ul class="inner-menu nav">
                  <li class="inner-menu-item"><a href="#step1">1</a><span class='text'>Ideating</span></li>
                  <li class="inner-menu-item"><a href="#step2">2</a><span class='text'>Designing</span></li>
                  <li class="inner-menu-item"><a href="#step3">3</a><span class='text'>Developing</span></li>
                  <li class="inner-menu-item"><a href="#step4">4</a><span class='text'>Iterating</span></li>
                </ul>
              </nav>
            </div>
            ...
            <div class="process-wrapper">
              ...
              <div id="step1" class="step col-md-11 col-md-offset-1">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 margin-top">
                    <img class="portfolio_picture" alt="Sketches" src="/img/princessrun/sketch.jpg">
                  </div>
                  <div class="col-sm-6 margin-top">
                    <img class="portfolio_picture" alt="Sketches" src="/img/princessrun/sketch2.jpg">
                  </div>
                </div>
              </div>
              ...
              <div id="step2" class="step col-md-11 col-md-offset-1">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <p>I started building different types of ground sprites and an 'evil' dragon to act as the enemy in this game.</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-7">
                      <img class="portfolio_picture" alt="Ground Sprites" src="/img/princessrun/illustrator-01.jpg">
                  </div>
                  <div class="col-sm-5">
                ...
                <div class="row margin-top">
                  <div class="col-sm-7">
                    <img class="portfolio_picture" alt="Dragon Sprites" src="/img/princessrun/illustrator-02.jpg">
                  </div>
                  <div class="col-sm-5">
                ...
                <div class="row margin-top">
                  <div class="col-sm-7">
                    <img class="portfolio_picture" alt="Testing out Images in Illustrator" src="/img/princessrun/illustrator-03.jpg">
                  </div>
                  <div class="col-sm-5">
              ...
              <div id="step3" class="step col-md-11 col-md-offset-1">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <p>I approached coding this game by taking everything one step at a time. I added the ground layer with the background first. I added the different components as I went because I wanted to make sure one piece was fully working and I could focus on debugging one problem at a time.</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-7">
                ...
                <div class="row margin-top">
                  <div class="col-sm-7">
                    <img class="portfolio_picture" alt="Ground Sprites" src="/img/princessrun/code-02.png">
                  </div>
                  <div class="col-sm-5">
                ...
                <div class="row margin-top">
                  <div class="col-sm-7">
                    <img class="portfolio_picture" alt="Flying Dragon" src="/img/princessrun/code-03.png">
                  </div>
                  <div class="col-sm-5">
                ...
                <div class="row margin-top">
                  <div class="col-sm-7">
                    <img class="portfolio_picture" alt="Code to Randomize Game in Atom" src="/img/princessrun/code-04.jpg">
                  </div>
                  <div class="col-sm-5">
              ...
              <div id="step4" class="step col-md-11 col-md-offset-1">
                ...
                <div class="row">
                  <div class="col-sm-6 margin-top">
                    <img class="portfolio_picture" alt="Playtest" src="/img/princessrun/playtest.jpg">
                  </div>
                  <div class="col-sm-6 margin-top">
                    <img class="portfolio_picture" alt="Playtest at Filmgate" src="/img/princessrun/playtest2.jpg">
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-6 margin-top">
                    <img class="portfolio_picture" alt="Final Version" src="/img/princessrun/princessrun_final2.jpg">
                  </div>
                  <div class="col-sm-6 margin-top">
                    <img class="portfolio_picture" alt="Final Version" src="/img/princessrun/princessrun_final.jpg">
                  </div>
                </div>
              </div>
      ...
      <div class="container-fluid space final-product">
        <div class="container">
          ...
          <div class="row">
            ...
            <h2 class="center white">Iterations</h2>
            <div class="row">
              <div class="col-sm-offset-5 col-sm-2 col-xs-offset-4 col-xs-4">
                <div class="lineBreak"></div>
              </div>
            ...
            <div class="col-sm-8 col-sm-offset-2">
              <p class="intro">There were three iterations of this project</p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12 margin-bottom">
              <div class="carousel">
                <div><img class="carousel_image" src="/img/princessrun/iteration1.jpg" alt="Iteration 1"><h4 class="center">Iteration 1</h4></div>
                <div><img class="carousel_image" src="/img/princessrun/iteration2.jpg" alt="Iteration 2"><h4 class="center">Iteration 2</h4></div>
                <div><img class="carousel_image" src="/img/princessrun/iteration3.jpg" alt="Iteration 3"><h4 class="center">Iteration 3</h4></div>
              </div>
            </div>
          </div>
        </div>
