...
<html>
    <head>
        ...
        <title>Portfolio | The Good Lemon</title>
    ...
    <body data-spy="scroll" data-target=".inner-navbar">
          ...
          <div class="row row-wrapper flex flex_box">
            <div class="col-sm-6 col-wrapper flex-vertical-align portfolio-header">
              <div class="content-wrapper">
                <h1 data-aos="fade-down">The Good Lemon</h1>
                <div class="row">
                  <div class="col-xs-4 col-xs-offset-4 col-sm-offset-0">
                    <div class="lineBreak"></div>
                  </div>
                </div>
                <h4>2016 Sapient Intern Project</h4>
              </div>
            </div>
      ...
      <div class="container-fluid overview">
        <div class="container">
          <h6 class="center">The Good Lemon</h6>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <p>My role in the project was to design and develop the microsite for the project. I knew I wanted to create a single page that explained what our project was and had a link for people to donate to our GoFundMe page.I came up with different ideas and discussed them with the design team to solidfy a design to build. Then I developed the page with HTML/CSS/Javascript while our developer worked to pull in the Twitter/Instagram APIS and built a backend system so we could update the numbers dymanically on the chart on our page.</p>
            </div>
            <div class="col-md-3 col-md-offset-1">
              <div class='list-wrapper'>
                <div class="row">
                  ...
                  <div class="hidden-xs col-sm-3 col-md-12">
                    <h5>Tools</h5>
                    <p class="list first">HTML/CSS</p>
                    <p class="list">Javascript</p>
                    <p class="list last">Axure</p>
                  </div>
                  <div class="hidden-xs col-sm-3 col-md-12">
                    <h5>Deliverables</h5>
                    <p class="list first">Wireframes</p>
                    <p class="list last">Front-End of Website</p>
                  </div>
                  <div class="hidden-xs col-sm-3 col-md-12">
                    <h5>Date</h5>
                    <p class="list first">July - Aug 2016</p>
                  </div>
      ...
      <div class="container-fluid space product-showcase color-panel">
        <div class="container">
          <h6 class="white">The Good Lemon</h6>
          <div class="row">

            <h2 class="center white">The Project</h2>
            <div class="row">
            ...
            <div class="col-sm-8 col-sm-offset-2">
              <p class="intro"> This was the video of our project produced and edited by Claire Zimmerman.</p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
              <div class="videoWrapper">
                <iframe width="100%" height="auto" src="https://www.youtube.com/embed/--5fw_iDDHY" frameborder="0" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row process-row-wrapper">
            ...
            <div class="col-md-1 hidden-xs hidden-sm inner-navbar-wrapper">
              <nav class="inner-navbar">
                <ul class="inner-menu nav">
                  <li class="inner-menu-item"><a href="#step1">1</a><span class='text'>Sketching</span></li>
                  <li class="inner-menu-item"><a href="#step2">2</a><span class='text'>Wireframing/Prototyping</span></li>
                  <li class="inner-menu-item"><a href="#step3">3</a><span class='text'>Developing</span></li>
                </ul>
              </nav>
            </div>
            ...
            <div class="process-wrapper">
              ...
              <div id="step1" class="step col-md-11 col-md-offset-1">
                <p class="headerline">1. Sketching</p>
                <h4 class="color">Coming up with Ideas</h4>
                <div class="row">
                  <div class="col-xs-2">
              ...
              <div id="step2" class="step col-md-11 col-md-offset-1">
                <p class="headerline">2. Wireframing/Prototyping</p>
                <h4 class="color">Getting Ideas into Axure</h4>
                <div class="row">
                  <div class="col-xs-2">
                    <div class="lineBreak project-steps"></div>
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-7">
                    <img class="portfolio_picture" alt="placeholder" src="/img/lemon/wire1.png">
                  </div>
                  <div class="col-sm-5">
                    <p>The first concept I developed was a "scrollytelling" story. As the user scrolled it would show a lemon being made into lemonade and would explain the idea of our project and "goodness". We decided that while it was flashy and fun, it didnt get to the point of our project fast enough. We wanted to feature our graph and how the stand was doing more prominently and spend less time on the cliche "making lemons into lemonade"</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-7">
                    <img class="portfolio_picture" alt="placeholder" src="/img/lemon/wire2.png">
                  </div>
                  <div class="col-sm-5">
                    <p>The second concept I came up with that was then devloped into the final site was using drawers to allow the user to show and hide content. Our site needed to show what the project was about, get people to donate online, show our #GoodLemon feed on Twitter and Instagram and display our graphs showing how "good" the Grove was. All of these are related to the projects but are not related to one another in any kindof chronological so a single page dispaying all of them at once seemed overwhelming and cluttered. Using drawers allowed us to separate out the content and create a stronger content heirarchy for the page.</p>
                    <a target="_blank" href="http://tmew7w.axshare.com">
                      <button type="button" target="_blank" class="btn btn-default pdf-button">Final Prototype</button>
                    </a>
                  </div>
              ...
              <div id="step3" class="step col-md-11 col-md-offset-1">
                ...
                <h4 class="color">Building the Website from Scratch</h4>
                <div class="row">
                  <div class="col-xs-2">
                    <div class="lineBreak project-steps"></div>
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <p>I built the website from scratch using Bootstrap and SASS. The designers and I worked to create a cohesive look for the site and write the content to explain what our project was and what it was about. I wanted to add fun, subtle interations to different parts of the site.</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-7">
                    <img class="portfolio_picture" alt="placeholder" src="/img/lemon/link.png">
                  </div>
                  <div class="col-sm-5">
                    <p>When the links on the drawers are hovered over then little animatons appear on the chalkboard backgrounds.</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-7">
                    <img class="portfolio_picture" alt="placeholder" src="/img/lemon/count.png">
                  </div>
                  <div class="col-sm-5">
                ...
                <div class="row center">
                  <div class="col-sm-12">
                    <a target="_blank" href="/projects/good_lemon">
                      <button type="button" target="_blank" class="btn btn-default pdf-button">Final Front-End Code</button>
                    </a>
                  </div>
                </div>
              </div>
