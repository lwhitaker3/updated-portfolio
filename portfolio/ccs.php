...
<html>
    ...
    <body data-spy="scroll" data-target=".inner-navbar">
          ...
          <div class="row row-wrapper flex flex_box">
            <div class="col-md-6 col-wrapper flex-vertical-align portfolio-header">
              <div class="content-wrapper">
                <h1 data-aos="fade-down">CCS</h1>
                <div class="row">
                  <div class="col-xs-4 col-xs-offset-4 col-md-offset-0">
                    <div class="lineBreak"></div>
                  </div>
                </div>
                <h4>Designing Microsites for the Department of Computational Science</h4>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <p>Ucompute was a redesign of an existing site. The original site was 50 or so links organized under headings that were not completely acurate. Our job was to reorganize the site content and develop a new structure for organizing the content so a user could quickly find a section they were looking for.</p>
              <p>Omadamathy was a completely new site designed to introduce this new term meaning "team-knowlegde". We developed a theme in wordpress and handed it over to the department so they could continue to add content to the site as they desired.</p>
            </div>
              ...
              <div class='list-wrapper'>
                <div class="row">
                  ...
                  <div class="hidden-xs col-sm-3 col-md-12">
                    ...
                    <p class="list">Front-End Development</p>
                    <p class="list">Information Architecture</p>
                  ...
                  <div class="hidden-xs col-sm-3 col-md-12">
                    <h5>Deliverables</h5>
                    <p class="list first">Ucompute page</p>
                    <p class="list last">Omadamathy microsite</p>
                  </div>
                  <div class="hidden-xs col-sm-3 col-md-12">
                    <h5>Date</h5>
                    <p class="list first">Oct 2015-Dec 2016</p>
                  </div>
      ...
      <div class="container-fluid space product-showcase color-panel">
        <div class="container">
          <h6 class="white">CCS</h6>
          <div class="row">

            <h2 class="center white">The Sites</h2>
            <div class="row">
            ...
            <div class="col-sm-8 col-sm-offset-2">
              <p class="intro"> Both sites have a clean and simple design so users are able to find the resources they are looking for quickly.</p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
          ...
          <div class="row process-row-wrapper">
            ...
            <div class="col-md-1 hidden-xs hidden-sm inner-navbar-wrapper">
              <nav class="inner-navbar">
                <ul class="inner-menu nav">
                  <li class="inner-menu-item"><a href="#step1">1</a><span class='text'>Ucompute</span></li>
                  <li class="inner-menu-item"><a href="#step2">2</a><span class='text'>Omadamathy</span></li>
                </ul>
              </nav>
            </div>
            ...
            <div class="process-wrapper">
              ...
              <div id="step1" class="step col-md-11 col-md-offset-1">
                <p class="headerline">1. Ucompute</p>
                <h4 class="color">Developing New Information Architecture</h4>
                <div class="row">
                  <div class="col-xs-2">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <p>Sarah and I had the task of redesigning the existing site. We started by looking at the existing design and identifying the areas for improvement. The next step was to sort all of the portals into categories to make it easy for a user to find what site they were looking for.</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-6">
                    <img class="portfolio_picture" alt="placeholder" src="/img/ccs/ucompute_original.png">
                  </div>
                  <div class="col-sm-6">
                    <p class="caption">This was the design of the original site. Some of the areas we identfied to be improved on were:
                    <ul>
                      <li>The categories the cards were organized into were not very descriptive</li>
                      <li>The cards were very large</li>
                      <li>Very long page to scroll through with no way to filter options</li>
                      <li>No visual hierarchy</li>
                      <li>The cards created an awkward layout if the number of cards in a category was not a multiple of six.</li>
                    </ul>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-6">
                    <img class="portfolio_picture" alt="placeholder" src="/img/ccs/sorting1.jpeg">
                  </div>
                  <div class="col-sm-6">
                    <p class="caption">We asked some users to organize the links into categories they felt made sense because they had a better understanding of the links and what fits together than we did.</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-6">
                    <img class="portfolio_picture" alt="placeholder" src="/img/ccs/sorting2.jpeg">
                  </div>
                  <div class="col-sm-6">
                    <p class="caption">We realized the portals fell into three broad categories: Tutorials/Classes, Tools, and Resources. Based on that we sorted all of the portals in sub-categories.</p>
                  </div>
                </div>

                <h4 class="color margin-top">Wireframing and Redesigning</h4>
                <div class="row">
                  <div class="col-xs-2">
                    <div class="lineBreak project-steps"></div>
                  </div>
                ...
                <div class="row margin-top">
                  <div class="col-sm-6">
                    <img class="portfolio_picture" alt="placeholder" src="/img/ccs/wireframe1.png">
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="row margin-top">
                  <div class="col-sm-6">
                    <img class="portfolio_picture" alt="placeholder" src="/img/ccs/wireframe2.png">
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="row margin-top">
                  <div class="col-sm-6">
                    <img class="portfolio_picture" alt="placeholder" src="/img/ccs/wireframe3.png">
                  </div>
                  <div class="col-sm-6">
                ...
                <h4 class="color margin-top">Developing</h4>
                <div class="row">
                  <div class="col-xs-2">
                    <div class="lineBreak project-steps"></div>
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <p>The final design incorporated several different elements to make the experience much easier for a user to find what they are looking for on this site.</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-6">
                ...
                <div class="row margin-top">
                  ...
                  <div class="col-sm-6">
                    <p class="caption">This is the layout for the portal links. We chose to use just the logos instead of colorful pictures. We used color only for the title and the difficulty rating so keep the design very simple and clean.</p>
                  </div>
                </div>
              </div>

              <div id="step2" class="step col-md-11 col-md-offset-1">
                <p class="headerline">2. Omadamathy</p>
                <h4 class="color">Designing the Site</h4>
                <div class="row">
                  <div class="col-xs-2">
                    <div class="lineBreak project-steps"></div>
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <p>We met with Dr. Khuri to find out what her vision for the site was. From there we used sketch to design the look of the site.</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-6">
                    <!-- <img class="portfolio_picture" alt="placeholder" src="/img/ccs/ucompute-menu.png"> -->NOTES
                  </div>
                  <div class="col-sm-6">
                    <p class="caption">Notes the meetings about the site. Since this website was a vison Dr. Khuri has it was important to understand what she was looking to communicate on the site.</p>
                  </div>
                </div>
                <div class="row margin-top">
                  <div class="col-sm-6">
                    <img class="portfolio_picture" alt="placeholder" src="/img/ccs/omada-sketch.png">
                  </div>
                  <div class="col-sm-6">
                    <p class="caption">The sketch files for the site.</p>
                  </div>
                </div>
                ...
                <div class="row margin-top">
                  <div class="col-sm-6">
                    <img class="portfolio_picture" alt="placeholder" src="/img/ccs/omada-code.png">
                    <p class="caption">Developing the theme in Atom using FoundationPress</p>
                  </div>
                  <div class="col-sm-6">
                    <img class="portfolio_picture" alt="placeholder" src="/img/ccs/omada-final.png">
                    <p class="caption">The final "teaching page"</p>
                  </div>
                </div>
              </div>
