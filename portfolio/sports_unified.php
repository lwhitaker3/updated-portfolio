...
<html>
    <head>
        ...
        <title>Portfolio | Sports Unified</title>
    ...
    <body data-spy="scroll" data-target=".inner-navbar">
          ...
          <div class="row row-wrapper flex flex_box">
            <div class="col-sm-6 col-wrapper flex-vertical-align portfolio-header">
              <div class="content-wrapper">
                <h1 data-aos="fade-down">Sports Unified</h1>
                <div class="row">
      ...
      <div class="container-fluid overview">
        <div class="container">
          <h6 class="center">Sports Unified</h6>
          <div class="row">
              ...
              <div class='list-wrapper'>
                <div class="row">
                  ...
                  <div class="hidden-xs col-sm-3 col-md-12">
                    ...
                    <p class="list">Mobile App Design</p>
                    <p class="list last">Translating Research into Design</p>
                  </div>
                  <div class="hidden-xs col-sm-3 col-md-12">
                    <h5>Tools</h5>
                    <p class="list first">Sketch</p>
                    <p class="list last">inVision</p>
                  </div>
                  <div class="hidden-xs col-sm-3 col-md-12">
                    <h5>Deliverables</h5>
                    <p class="list first">Prototype for Admin App</p>
                    <p class="list last">Prototype for Player App</p>
                  </div>
                  <div class="hidden-xs col-sm-3 col-md-12">
                    <h5>Date</h5>
                    <p class="list first">Aug - Dec 2016</p>
                  </div>
      ...
      <div class="container-fluid space product-showcase color-panel">
        <div class="container">
          <h6 class="white">Sports Unified</h6>
          <div class="row">
            ...
            <div class="col-sm-8 col-sm-offset-2">
              <p class="intro"> Check out our promotional video.</p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
              <div class="videoWrapper">
                <iframe width="100%" height="auto" src="https://www.youtube.com/embed/kis6i2CfmDE" frameborder="0" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-1 hidden-xs hidden-sm inner-navbar-wrapper">
              <nav class="inner-navbar">
                <ul class="inner-menu nav">
                  <li class="inner-menu-item"><a href="#step1">1</a><span class='text'>Designing</span></li>
                  <li class="inner-menu-item"><a href="#step2">2</a><span class='text'>Gathering Feedback</span></li>
                  <li class="inner-menu-item"><a href="#step3">3</a><span class='text'>Iterating</span></li>
                  <li class="inner-menu-item"><a href="#step4">4</a><span class='text'>Final</span></li>
                </ul>
              </nav>
            </div>
      ...
      <div class="container-fluid space final-product">
        <div class="container">
          ...
          <div class="row">
            ...
            <h2 class="center white">THE SCREENS</h2>
            <div class="row">
              <div class="col-sm-offset-5 col-sm-2 col-xs-offset-4 col-xs-4">
                <div class="lineBreak"></div>
              </div>
