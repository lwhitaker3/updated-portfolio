...
<html>
    ...
    <body data-spy="scroll" data-target=".inner-navbar">
          ...
          <div class="row row-wrapper flex flex_box">
            <div class="col-md-6 col-wrapper flex-vertical-align portfolio-header">
              <div class="content-wrapper">
                <h1 data-aos="fade-down">Usability Testing DOCS</h1>
                <div class="row">
                  <div class="col-xs-4 col-xs-offset-4 col-md-offset-0">
                    <div class="lineBreak"></div>
                  </div>
                </div>
                <h4>Heuristic Evaluation and Formative Usability Testing of DOCS site</h4>
              </div>
            </div>
      ...
      <div class="container-fluid overview">
        <div class="container">
          <h6 class="center">Usability Testing</h6>
          <div class="row">
      ...
      <!-- <div class="container-fluid space product-showcase color-panel">
        <div class="container">
          <h6 class="white">Usability Testing</h6>
          <div class="row">
          ...
          <div class="row process-row-wrapper">
            ...
            <div class="process-wrapper">
              ...
              <div id="step2" class="step col-md-11 col-md-offset-1">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <p>Once we got to know the website and had an idea of the problems we thought users would have while using the site, we put together a testing protocol. We designed a test plan with 6 scenarios that we felt would address the main tasks on the site and allow us to explore the issues we found. We ran pilot studies to refine the task scenarios and make sure they were as clear as possible without being too obvious.</p>
                    <a target="_blank" href="/projects/Test_Plan.pdf">
                      <button type="button" class="btn btn-default margin-top">Test Plan</button>
                    </a>
                    <a target="_blank" href="/projects/Moderator_Guide.pdf">
                      <button type="button" class="btn btn-default margin-top">Moderator Packet</button>
                    </a>
                    <a target="_blank" href="/projects/Participant_Packet.pdf">
                      <button type="button" class="btn btn-default margin-top">Participant Packet</button>
                    </a>
                  </div>
              ...
              <div id="step4" class="step col-md-11 col-md-offset-1">
                ...
                <div class="row margin-top">
                  ...
                  <div class="col-sm-6">
                    ...
                    <a target="_blank" href="/projects/full_usability_report.pdf">
                      <button type="button" class="btn btn-default ">See full report</button>
                    </a>
                  </div>
                </div>
              </div>
